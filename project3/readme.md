...
## **Part 2: Person.java (Back-end + DB) <8 points>**
...
## **Part 3: Match.java (Back-end + DB) <8 points>**
...
## **Part 4: JSP Files (add.jsp) (Front-end) <4 points>**
...
## **Part 5: Web Servlets (AddPerson.java) (Back-end + Front-end) <4 points>**
